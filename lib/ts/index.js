...
exports.createTypeScriptProject = void 0;
...
const TsconfigFileCreator_1 = __importDefault(require("./TsconfigFileCreator"));
function createTypeScriptProject(projectConfig) {
    ...
    new TsconfigFileCreator_1.default(projectConfig).create();
}
